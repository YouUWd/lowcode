      ...
      <tbody class="text-sm">
            ...
            <div class="flex justify-center">
              ...
              >
                <div class="w-11 h-6 rounded-full transition-all duration-200" 
                     :class="activePermissions.has(`${field.entity}.${field.name}.${type}`) 
                ...
                <div class="absolute top-[2px] left-[2px] w-5 h-5 bg-white rounded-full transition-all duration-200 shadow-sm"
                     :class="activePermissions.has(`${field.entity}.${field.name}.${type}`) ? 'translate-x-5' : 'translate-x-0'">
                </div>
              </button>
            </div>
          </td>
        ...
        <tr v-if="fields.length === 0">
          <td colspan="4" class="p-20 text-center text-on-surface-variant opacity-40">
            <span class="material-symbols-outlined text-6xl mb-4">security_update_warning</span>
